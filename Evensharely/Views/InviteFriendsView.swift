    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 24) {
                ...
                Text("Invite Friends to Evensharely")
                    .font(.title2)
                    .fontWeight(.bold)
                
                Text("Connect with friends to easily share links and collaborate.")
                    .font(.subheadline)
...
#Preview {
    InviteFriendView(userID: "000866.c7c9a90c75834932b91822b2739c37ce.2033")
}
