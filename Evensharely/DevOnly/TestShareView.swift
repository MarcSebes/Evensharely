...
struct TestShareView: View {
    @State private var previewHeight: CGFloat = 200.0
...
class ShareSheetCustomLinkView: LPLinkView {
...
#Preview {
    TestShareView(sharedURL: URL(string: "https://www.instagram.com/p/DJt0uz9CSv5/?utm_source=ig_web_copy_link")!, onComplete: doNothing)
}
